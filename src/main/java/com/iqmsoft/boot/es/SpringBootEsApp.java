...
import com.iqmsoft.boot.es.repository.CustomerRepository;

@SpringBootApplication
public class SpringBootEsApp implements CommandLineRunner{

	@Autowired
	private CustomerRepository customerRepository;	
	
	public static void main(String[] args) {
		SpringApplication.run(SpringBootEsApp.class, args);
	}
